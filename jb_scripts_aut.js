...
function jb_init($, CodeMirror, hasher, crossroads, URI) {
    ...
    **********************************************/ 
    ...
    $(document).on('click', '#Autoren', function(e) {
        e.preventDefault();
        $('#resultOptions').addClass('showAut');
        $('#showListAut').slideDown('slow');
            $('#showList').slideUp('slow'); 
        
    });
    $(document).on('click', '#Treffer', function(e) {
        e.preventDefault();
        $('#resultOptions').removeClass('showAut');
        $('#showList').slideDown('slow');
            $('#showListAut').slideUp('slow'); 
