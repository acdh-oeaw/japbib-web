...
declare variable $_:maxNumberOfChangesPerJob external := 9000;
...
declare variable $subject := "Beitrag zu Sammelwerk";
declare variable $genre := "bookSection";
declare variable $genretoMatch := "^[bB]ookSection$";
...
declare %updating function _:transform($e as element(mods:mods)) {
      let $firstSubject := $e/mods:subject[1],
        ...
        {comment {'#Task #10382,1.2 add '||$subject}}
